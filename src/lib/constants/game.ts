...
/** Через сколько секунд после нажатия кнопка «Я жив» снова станет активной (6 часов). */
export const COOLDOWN_SECONDS = 6 * 60 * 60;

/** Через сколько секунд без нажатия персонаж погибает (12 часов). */
export const LIFESPAN_SECONDS = 12 * 60 * 60;
